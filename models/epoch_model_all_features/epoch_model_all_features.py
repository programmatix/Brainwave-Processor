...
def create_and_add_all(merged, target_feature: str, predict_mode: bool):
    models_and_data: list[ModelAndData] = []

    create_and_add(predict_mode, models_and_data,  False, target_feature, target_feature, ["eeg", "physical", "sleep_stage", "times"], [], merged, lambda X: X)
