...
def create_and_add_all(merged, predict_mode: bool):
    ...
    create_and_add(predict_mode, models_and_data, True, f"is15MinsBeforeReadyToSleep_AllEeg+Physical_1HrBefore", "15MinsBeforeReadyToSleep", ["eeg",  "physical"], [], merged, False, lambda X: X[(X['minsSinceReadyToSleep'] <= 0) & (X['minsSinceReadyToSleep'] >= -60)])
    create_and_add(predict_mode, models_and_data, True, f"is15MinsBeforeReadyToSleep_BestEeg+Physical_1HrBefore", "15MinsBeforeReadyToSleep", ["best_eeg",  "physical"], [], merged, False, lambda X: X[(X['minsSinceReadyToSleep'] <= 0) & (X['minsSinceReadyToSleep'] >= -60)])
    create_and_add(predict_mode, models_and_data, True, f"is15MinsBeforeReadyToSleep_BestEeg+Temp_1HrBefore", "15MinsBeforeReadyToSleep", ["best_eeg",  "temp"], [], merged, False, lambda X: X[(X['minsSinceReadyToSleep'] <= 0) & (X['minsSinceReadyToSleep'] >= -60)])
    create_and_add(predict_mode, models_and_data, True, f"is15MinsBeforeReadyToSleep_BestEeg_1HrBefore", "15MinsBeforeReadyToSleep", ["best_eeg"], [], merged, False, lambda X: X[(X['minsSinceReadyToSleep'] <= 0) & (X['minsSinceReadyToSleep'] >= -60)])
