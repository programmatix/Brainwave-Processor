...
def create_and_add_all(merged, predict_mode: bool):
    ...
    # BestEEG is almost identical
    # create_and_add(predict_mode, models_and_data,  False, f"energy", "energy:energyScore", ["eeg", "physical", "sleep_stage"], [], merged, lambda X: X)
    create_and_add(predict_mode, models_and_data,  False, f"energyBestEEG", "energy:energyScore", ["best_eeg", "physical", "sleep_stage", "times"], [], merged, lambda X: X)
