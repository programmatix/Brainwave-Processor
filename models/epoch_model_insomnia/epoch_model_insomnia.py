...
def create_and_add_all(merged, predict_mode: bool):
    ...
    create_and_add(predict_mode, models_and_data,  True, "SSLongWakeThisNightAndIsBeforeNoTime", "SSLongWakeThisNightAndIsBefore", ["eeg_no_future", "physical", "sleep_stage_no_times"], [], merged, lambda X: X)
